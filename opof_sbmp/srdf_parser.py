# Taken from https://github.com/ros-planning/srdfdom
# which did not have a PyPI release.
...
xmlr.reflect(JointVal, params=[name_attribute, xmlr.Attribute("value", "vector")])
...
xmlr.reflect(
    Sphere,
    params=[xmlr.Attribute("center", str), xmlr.Attribute("radius", float)],
)
...
xmlr.reflect(
    Chain,
    params=[xmlr.Attribute("base_link", str), xmlr.Attribute("tip_link", str)],
)
...
xmlr.reflect(PassiveJoint, params=[name_attribute])
